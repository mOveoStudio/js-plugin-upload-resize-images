...
define([
  ...
  'backbone'
    ...
    var ThumbnailCropper = Backbone.Model.extend({
    ...
    ThumbnailCroppers = Backbone.Collection.extend({
    ...
    return {
        thumbnailModel : ThumbnailCropper,
        thumbnailsCollection : ThumbnailCroppers
    };
